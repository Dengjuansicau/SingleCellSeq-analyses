setwd("/cellranger_results_sheep_V1/")
...
e45.data <- Read10X(data.dir = "/cellranger_results_sheep_V1/e45/")
...
e45 <- subset(e45, subset = nFeature_RNA > 200 & nFeature_RNA < 5000 &nCount_RNA < 40000 & percent.mt < 40)
...
saveRDS(e45, file = "e45_sheep_clean.rds")

#### e60 pretreatment ###
#### Setup the Seurat objects ###

e60.data <- Read10X(data.dir = "/cellranger_results_sheep_V1/e60/")
...
e60 <- subset(e60, subset = nFeature_RNA > 200 & nFeature_RNA < 5000 &nCount_RNA < 40000 & percent.mt < 30)
...
saveRDS(e60, file = "e60_sheep_clean.rds")

#### e75 pretreatment ###
#### Setup the Seurat objects ###

e75.data <- Read10X(data.dir = "/cellranger_results_sheep_V1/e75/")
...
e75 <- subset(e75, subset = nFeature_RNA > 200 & nFeature_RNA < 6000 &nCount_RNA < 75000 & percent.mt < 25)
...
saveRDS(e75, file = "e75_sheep_clean.rds")

#### e90 pretreatment ###
#### Setup the Seurat objects ###

e90.data <- Read10X(data.dir = "/cellranger_results_sheep_V1/e90/")
...
e90 <- subset(e90, subset = nFeature_RNA > 200 & nFeature_RNA < 5000 &nCount_RNA < 50000 & percent.mt < 40)
...
saveRDS(e90, file = "e90_sheep_clean.rds")

#### e105 pretreatment ###
#### Setup the Seurat objects ###

e105.data <- Read10X(data.dir = "/cellranger_results_sheep_V1/e105/")
...
e105 <- subset(e105, subset = nFeature_RNA > 200 & nFeature_RNA < 4000 &nCount_RNA < 50000 & percent.mt < 20)
...
saveRDS(e105, file = "e105_sheep_clean.rds")

#### e120 pretreatment ###
#### Setup the Seurat objects ###

e120.data <- Read10X(data.dir = "/cellranger_results_sheep_V1/e120/")
...
e120 <- subset(e120, subset = nFeature_RNA > 200 & nFeature_RNA < 4000 &nCount_RNA < 40000 & percent.mt < 30)
...
saveRDS(e120, file = "e120_sheep_clean.rds")

#### e135 pretreatment ###
#### Setup the Seurat objects ###

e135.data <- Read10X(data.dir = "/cellranger_results_sheep_V1/e135/")
...
e135 <- subset(e135, subset = nFeature_RNA > 200 & nFeature_RNA < 5000 &nCount_RNA < 50000 & percent.mt < 50)
...
saveRDS(e135, file = "e135_sheep_clean.rds")

#### d0 pretreatment ###
#### Setup the Seurat objects ### 
d0.data <- Read10X(data.dir = "/cellranger_results_sheep_V1/d0/")
...
d0 <- subset(d0, subset = nFeature_RNA > 200 & nFeature_RNA < 4000 &nCount_RNA < 55000 & percent.mt < 50)
...
saveRDS(d0, file = "d0_sheep_clean.rds")

#### d7 pretreatment ###
#### Setup the Seurat objects ###

d7.data <- Read10X(data.dir = "/cellranger_results_sheep_V1/d7/")
...
d7 <- subset(d7, subset = nFeature_RNA > 200 & nFeature_RNA < 4000 &nCount_RNA < 60000 & percent.mt < 60)
...
saveRDS(d7, file = "d7_sheep_clean.rds")

#### d14 pretreatment ###
#### Setup the Seurat objects ###

d14.data <- Read10X(data.dir = "/cellranger_results_sheep_V1/d14/")
...
d14 <- subset(d14, subset = nFeature_RNA > 200 & nFeature_RNA < 5000 &nCount_RNA < 80000 & percent.mt < 70)
...
saveRDS(d14, file = "d14_sheep_clean.rds")

#### d21 pretreatment ###
#### Setup the Seurat objects ###

d21.data <- Read10X(data.dir = "/cellranger_results_sheep_V1/d21/")
...
d21 <- subset(d21, subset = nFeature_RNA > 200 & nFeature_RNA < 5000 &nCount_RNA < 100000 & percent.mt < 70)
...
saveRDS(d21, file = "d21_sheep_clean.rds")

#### d28 pretreatment ###
#### Setup the Seurat objects ###

d28.data <- Read10X(data.dir = "/cellranger_results_sheep_V1/d28/")
...
d28 <- subset(d28, subset = nFeature_RNA > 200 & nFeature_RNA < 6000 &nCount_RNA < 100000 & percent.mt < 75)
...
saveRDS(d28, file = "d28_sheep_clean.rds")

#### d35 pretreatment ###
#### Setup the Seurat objects ###

d35.data <- Read10X(data.dir = "/cellranger_results_sheep_V1/d35/")
...
d35 <- subset(d35, subset = nFeature_RNA > 200 & nFeature_RNA < 4000 &nCount_RNA < 80000 & percent.mt < 50)
...
saveRDS(d35, file = "d35_sheep_clean.rds")

#### d42 pretreatment ###
#### Setup the Seurat objects ###

d42.data <- Read10X(data.dir = "/cellranger_results_sheep_V1/d42/")
...
d42 <- subset(d42, subset = nFeature_RNA > 200 & nFeature_RNA < 4000 &nCount_RNA < 60000 & percent.mt < 70)
...
saveRDS(d42, file = "d42_sheep_clean.rds")

#### d49 pretreatment ###
#### Setup the Seurat objects ###

d49.data <- Read10X(data.dir = "/cellranger_results_sheep_V1/d49/")
...
d49 <- subset(d49, subset = nFeature_RNA > 200 & nFeature_RNA < 4000 &nCount_RNA < 75000 & percent.mt < 70)
...
saveRDS(d49, file = "d49_sheep_clean.rds")

#### d56 pretreatment ###
#### Setup the Seurat objects ###

d56.data <- Read10X(data.dir = "/cellranger_results_sheep_V1/d56/")
...
d56 <- subset(d56, subset = nFeature_RNA > 200 & nFeature_RNA < 4000 &nCount_RNA < 75000 & percent.mt < 70)
...
saveRDS(d56, file = "d56_sheep_clean.rds")

#### d90 pretreatment ###
#### Setup the Seurat objects ###

d90.data <- Read10X(data.dir = "/cellranger_results_sheep_V1/d90/")
...
d90 <- subset(d90, subset = nFeature_RNA > 200 & nFeature_RNA < 5000 &nCount_RNA < 60000 & percent.mt < 80)
...
saveRDS(d90, file = "d90_sheep_clean.rds")